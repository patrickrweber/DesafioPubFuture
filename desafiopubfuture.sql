...
CREATE TABLE `contas` (
  ...
  `novo_saldo1` float NOT NULL,
  `novo_saldo2` float NOT NULL,
...
INSERT INTO `contas` VALUES (1,300,'Carteira','Santander',0,0,0,0,'',0,0,0,''),(2,6000,'Conta Corrente','Itau',0,0,0,0,'',0,0,0,''),(3,2800,'Poupança','NuBank',0,0,0,0,'',0,0,0,'');
...
INSERT INTO `despesas` VALUES (1,200,'2022-01-07','2022-01-07','alimentacao',1),(2,200,'2022-01-07','2022-01-07','alimentacao',1),(3,200,'2022-01-07','2023-01-07','alimentacao',1),(4,200,'2022-01-07','2022-01-07','moradia',2),(10,300,'2022-01-10','2022-01-10','transporte',1);
...
INSERT INTO `receitas` VALUES (1,300,'2022-01-07','2022-01-07','1','salario',1),(2,200,'2022-07-01','2022-07-01','2','presente',2),(24,300,'2022-07-01','2022-07-01','2','outros',2);
...
-- Dump completed on 2022-01-12 14:00:42
